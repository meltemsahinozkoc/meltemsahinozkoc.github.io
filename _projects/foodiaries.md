...
<section class="foodiaries foodiaries--split"
         data-foodiaries="{{ '/assets/data/foodiaries.json' | relative_url }}">

  <!-- LEFT 40%: heatmap + filters (sticky) -->
  <aside class="foodiaries__sidebar">
  ...
  <!-- RIGHT 60%: count + grid + empty -->
  <main class="foodiaries__main">
